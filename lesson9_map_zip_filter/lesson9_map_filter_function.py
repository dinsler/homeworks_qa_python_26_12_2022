...
'''
Task3. Write a function that will accept two lists as input, and as a result return a list in which elements are combined
in pairs in tuples. Use the zip() function for this
'''
